...
FROM 'C:\Users\User\OneDrive\Documents\PostGresSQL\practical-sql-main\Chapter_10\acs_2011_2015_stats.csv'
...
AS bachelors_income_r,round(corr(pct_travel_60_min, median_hh_income)::numeric, 2) 
AS income_travel_r,round(corr(pct_travel_60_min, pct_bachelors_higher)::numeric, 2) 
...
FROM 'C:\Users\User\OneDrive\Documents\PostGresSQL\practical-sql-main\Chapter_10\fbi_crime_data_2015.csv'
WITH (FORMAT CSV, HEADER, DELIMITER ',');
