...
FROM 'C:\Users\User\OneDrive\Documents\PostGresSQL\practical-sql-main\Chapter_08\pls_fy2014_pupld14a.csv'
...
FROM 'C:\Users\User\OneDrive\Documents\PostGresSQL\practical-sql-main\Chapter_08\pls_fy2009_pupld09a.csv'
WITH (FORMAT CSV, HEADER);
...
SELECT count(salaries),count(*) FROM pls_fy2014_pupld14a;
SELECT count(salaries),count(*) FROM pls_fy2009_pupld09a;

SELECT count(libname), count(DISTINCT libname) FROM pls_fy2014_pupld14a;
SELECT count(libname), count(DISTINCT libname) FROM pls_fy2009_pupld09a;
...
SELECT pls14.stabr,
       sum(pls14.visits) AS visits_2014, sum(pls09.visits) AS visits_2009,
